...
function showPassword(id,hideElement,showElement) {
  ...
  function hidePassword(id,hideElement,showElement) {
  ...
  function goToStep2(){
    ...
    $("#stepContent_1").removeClass("active");
    $("#stepContent_2").addClass("active");
  ...
  function goToStep3(){
    ...
    $("#stepContent_1").removeClass("active");
    $("#stepContent_2").removeClass("active");
    $("#stepContent_3").addClass("active");
  ...
  function goToStep4(){
    ...
    $("#stepContent_1").removeClass("active");
    $("#stepContent_2").removeClass("active");
    $("#stepContent_3").removeClass("active");
    $("#stepContent_4").addClass("active");
    
  }

  function getPayValue(){
    const payValue = document.getElementById('payoption').value;
    if(payValue =='credit'){
